  ...
  <Base>
    <div class="c-box">
      ...
      <p class="mt-5 w-[300px] mx-auto">
        <span class="text-green-500">90%</span> افراد با ایت ایزیلی هرچیزی که
        دوست دارند اونقدر که دلشون بخواد و لذت ببرند و سیر بشن می‌تونن بخورن
        چـون قـوانین لاغـری ایت ایزیلـــی بدون محدودیت و خیلی قدرتمنده!!
      </p>
